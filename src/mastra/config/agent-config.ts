...
export const DEFAULT_INSTRUCTIONS = 'Coworker is an AI assistant that helps you with various tasks. You can customize these instructions to guide Coworker’s behavior and personality.';
